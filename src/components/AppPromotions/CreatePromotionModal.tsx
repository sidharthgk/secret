...
const CreatePromotionModal: React.FC<CreatePromotionModalProps> = ({ onClose }) => {
  const [formData, setFormData] = useState({
    name: '',
    description: '',
    scheduleFromDate: '',
    scheduleFromTime: '10:20',
    scheduleToDate: '',
    scheduleToTime: '10:20',
    audience: 'all',
    ageRange: '',
    gender: '',
    planType: ''
    ...
    <div className="fixed inset-y-0 right-0 w-[500px] bg-white shadow-xl z-50 transform transition-transform duration-300">
      <div className="flex flex-col h-full">
        <div className="flex justify-between items-center p-6 border-b border-gray-200">
          <h3 className="text-xl font-semibold">Create Promotions</h3>
